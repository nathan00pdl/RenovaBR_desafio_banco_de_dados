#Tratamento dos dados para serem inseridos diretos na tabela 'perfil_eleitorado_2020'

#Tratamento dos dados para serem inseridos diretos na tabela 'perfil_eleitorado_2020'

#(Base de dados: 'perfil_eleitorado_2020.csv')

#IMPORTANTE:
#O primeiro passo do tratamento da base de dados original (perfil_eleitorado_2020.csv) foi passar todo o arquivo para o formato UTF-8, para que fosse 
...
file_path = 'C:/Users/Nathan/Downloads/perfil_eleitorado_2020_FORMATADO.csv'
...
with open(file_path, 'w', newline='', encoding='utf-8') as csvfile:
    ...
    for row in data:
        ...
        for cell in row:
            cleaned_cell = cell.strip().replace(' ', '_')  #Substitui espaços por underscores e remove espaços extras de cada linha ("tupla")
...
#Base de dados a ser tratada (arquivo .CSV)
file_path = 'C:/Users/Nathan/Downloads/perfil_eleitorado_2020.csv'
...
#Removendo acentos e converte os caracteres para caixa baixa
for i, row in enumerate(rows):
    new_row = [to_lower(remove_accents(cell)) for cell in row]  
    rows[i] = new_row
...
#o máximo compatível para o momento ao qual fosse transferir os dados para a tabela "perfil_eleitorado_2020" no banco de dados.
